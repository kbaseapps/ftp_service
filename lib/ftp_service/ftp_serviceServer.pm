package ftp_service::ftp_serviceServer;
...
sub call_method {
    ...
    my $ctx = ftp_service::ftp_serviceServerContext->new($self->{loggers}->{userlog},
...
{
    # Service ftp_service requires authentication.
    ...
    my @result;
    {
        ...
        my $stderr = ftp_service::ftp_serviceServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service ftp_service.");
    }
...
package ftp_service::ftp_serviceServerContext;

use strict;

=head1 NAME

ftp_service::ftp_serviceServerContext
...
package ftp_service::ftp_serviceServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = ftp_service::ftp_serviceServer->new(
